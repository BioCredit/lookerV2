# The name of this view in Looker is "Tbl Download Report By Device"
view: tbl_download_report_by_device {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dev2_biocredit_app.Tbl_Download_Report_by_Device` ;;
