# The name of this view in Looker is "Custom Field Form Config Copia"
view: custom_field_form_config_copia {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dev2_biocredit_app.custom_field_form_config_copia` ;;
  ...
  dimension: custom_field_value {
    type: string
    sql: ${TABLE}.custom_field_value ;;
  }
