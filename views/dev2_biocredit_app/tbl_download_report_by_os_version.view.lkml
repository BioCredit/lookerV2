# The name of this view in Looker is "Tbl Download Report By OS Version"
view: tbl_download_report_by_os_version {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dev2_biocredit_app.Tbl_Download_Report_by_OS_Version` ;;
  ...
  dimension: android_os_version {
    type: string
    sql: ${TABLE}.Android_OS_Version ;;
  }
